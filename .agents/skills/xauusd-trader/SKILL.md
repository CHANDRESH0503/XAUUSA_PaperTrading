...
description: >
  ...
  series. Applies LOGIC.md as the source of truth and AGENTS.md's hard rules
...
1. Read `LOGIC.md` (the rule spec) and `AGENTS.md` (the hard rules). They override
...
## The hard rules you never break (from AGENTS.md)
